...
public class driverWithdrawSuccessPageB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.driver_withdrawsuccesspageb);

        success = findViewById(R.id.imageView14);
        ...
        btnContinue.setOnClickListener(v -> {
            ...
            Intent intent1 = new Intent(driverWithdrawSuccessPageB.this, driverIntWithdrawPage.class);
        ...
        btnBack.setOnClickListener(v -> {
            ...
            Intent intent2 = new Intent(driverWithdrawSuccessPageB.this, driverHomePage.class);
