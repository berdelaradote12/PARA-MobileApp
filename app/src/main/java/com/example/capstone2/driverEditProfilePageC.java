...
public class driverEditProfilePageC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.driver_editprofilepagec);
        ...
        btnCancel.setOnClickListener(v -> {
            ...
            Intent intent1 = new Intent(driverEditProfilePageC.this, driverEditProfilePageA.class);
        ...
        btnBack.setOnClickListener(v -> {
            ...
            Intent intent2 = new Intent(driverEditProfilePageC.this, driverProfilePage.class);
                    ...
                    for (DataSnapshot currentUser : dataSnapshot.getChildren()) {
                        ...
                        if (Objects.equals(currUserPassword, userPassword)) {
                            ...
                            txtError.setText(String.format("%s \n%s",text34,text36));
                                ...
                                Intent intent3 = new Intent(driverEditProfilePageC.this, driverEditProfilePageA.class);
                                intent3.putExtra("getUserId", accountId);
                                intent3.putExtra("getUserUsername", String.valueOf(accountUsername));
                                intent3.putExtra("getUserPassword", newUserPassword);
                                ...
                                // Temporary
                                Toast.makeText(driverEditProfilePageC.this,
