...
public class commuterLanguagePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.commuter_languagepage);
        ...
        btnFilipino.setOnClickListener(view -> {
            ...
            Intent intent1 = new Intent(commuterLanguagePage.this, commuterProfilePage.class);
            ...
            Toast.makeText(commuterLanguagePage.this,
        ...
        btnEnglish.setOnClickListener(view -> {
            ...
            Intent intent2 = new Intent(commuterLanguagePage.this, commuterProfilePage.class);
        ...
        btnBack.setOnClickListener(view -> {
            ...
            Intent intent3 = new Intent(commuterLanguagePage.this, commuterProfilePage.class);
